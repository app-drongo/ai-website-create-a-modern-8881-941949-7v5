...
export default function Footer() {
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Beach Access', href: '/beaches' },
  ...
  const socialLinks = [
    { name: 'Instagram', icon: Instagram, href: 'https://instagram.com/coastalretreatsmiami' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                ...
                with personalized concierge service and unmatched ocean views.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">+1 (305) 892-7456</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline flex items-center gap-1">
                Licensed & Insured <Heart className="size-3 text-red-500 fill-current" /> STR
                License #24-0891
              </span>
            </div>
