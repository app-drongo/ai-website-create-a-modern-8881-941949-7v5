...
export default function CTA() {
  const stats = [
    ...
    { value: '24/7', label: 'Concierge Service', icon: Calendar },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Experience luxury beachfront living in our handpicked collection of premium
                apartments. From oceanview penthouses to downtown lofts - your unforgettable Miami
                escape starts here.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Licensed & Insured • Featured on Top Travel Platforms
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                24/7 concierge support and local expertise
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Beachfront penthouses to downtown luxury lofts
              </p>
            </div>
          </div>
        </div>
